		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-8">
					...
					<div id="az-select1" class="az-select az-margin-bottom10">
						<select name="" id=""> 
							<option value="1">Сезон 2015/2016</option>
							<option value="2">Сезон 2014/2015</option>
							<option value="3">Сезон 2013/2014</option>
							<option value="4">Сезон 2012/2013</option>
							<option value="5">Сезон 2011/2012</option>
							<option value="6">Сезон 2010/2011</option>
							<option value="7">Сезон 2009/2010</option>
							<option value="8">Сезон 2008/2009</option>
							<option value="9">Сезон 2007/2008</option>							
						</select>
					</div>
